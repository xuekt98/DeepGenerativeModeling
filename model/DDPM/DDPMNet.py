...
from model.DDPM.base.modules.diffusionmodules.openaimodel import UNetModel
...
class DDPMNet(nn.Module):
    def __init__(self, config):
        ...
        model_params = config.model.DDPM.params
        self.num_timesteps = model_params.n_steps
        ...
        self.denoise_fn = UNetModel(config=self.config, **vars(model_params.UNetParams))
